...
if __name__ == '__main__':
    ...
    head = Hero(CORAL, scale_x(10), scale_x(5), head_group)
    head.direction = Run.right

    body = list()
    body_group = pygame.sprite.Group()
    body.append(Artefact(head.color, head.rect.x - scale_x(1), head.rect.y, body_group)) # noqa
    body.append(Artefact(head.color, head.rect.x - scale_x(2), head.rect.y, body_group)) # noqa
    body.append(Artefact(head.color, head.rect.x - scale_x(3), head.rect.y, body_group)) # noqa
